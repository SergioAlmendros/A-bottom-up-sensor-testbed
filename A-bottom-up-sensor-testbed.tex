...
\label{Chapter2}
  ...
  \section{Companies}
    ...
    \subsection{Smartcitizen}
      ...
      \begin{figure}[htbp]
        \centering
            \includegraphics[scale=0.1]{./Figures/smartcitizen.png}
            \rule{18em}{0.5pt}
    ...
    \subsection{Libelium}
      ...
      \begin{itemize}
        \item e-Health: A sensor shield for Arduino and Raspberry Pi for body monitoring: pulse, oxygen in blood, airflow, body temperature, electrocardiogram, glucometer, galvanic skin response, blood pressure, patient position, and muscle/eletromyography sensor. We can see the shield in the figure \ref{fig:Libeliumehealth}.
          \begin{figure}[htbp]
            \centering
                \includegraphics[scale=0.6]{./Figures/Libeliume_health.png}
                \\
                \rule{18em}{0.5pt}
        ...
        \item Waspmote: A sensor node where we can attach more than 60 sensors, solar powered, and though for adjust into street light posts. We can see the node in the figure \ref{fig:LibeliumWaspmote}.
          \begin{figure}[htbp]
            \centering
                \includegraphics[scale=0.5]{./Figures/LibeliumWaspmote.png}
                \\
                \rule{18em}{0.5pt}
       ...
       \item Smart Water: Is a wireless sensor platform for water quality monitoring, it also provides real-time data. We can see the node in the figure \ref{fig:LibeliumSmartWater}.
        \begin{figure}[htbp]
            \centering
                \includegraphics[scale=1]{./Figures/LibeliumSmartWater.png}
                \\
                \rule{16em}{0.5pt}
  ...
  \section{Sensor boards}
    ...
    \subsection{Arduino YUN}
      ...
      A powe over ethernet module (PoE) can be attach to the arduino, which is perfect for the guifi network, as their nodes are PoE.
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=1]{./Figures/BridgeInShort.png}
              \\
              \rule{16em}{0.5pt}
    ...
    \subsection{Raspberry Pi}
      ...
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=1]{./Figures/raspberry-pi-model-b-300x225.jpg}
              \\
              \rule{16em}{0.5pt}
    ...
    \subsection{Picoboard}
      ...
      \begin{figure}[htbp]
        \centering
            \includegraphics[scale=1]{./Figures/picoboard.jpg}
            \\
            \rule{16em}{0.5pt}
...
\label{Chapter3}
  ...
  \section{Arduino vs Raspberry PI}
    ...
    \begin{figure}[htbp]
      \centering
          \includegraphics[scale=1]{./Figures/arduinoethernetpoe.jpg}
          \\
          \rule{16em}{0.5pt}
    ...
    \begin{figure}[htbp]
      \centering
          \includegraphics[scale=1]{./Figures/poe-rpi.jpg}
          \\
          \rule{16em}{0.5pt}

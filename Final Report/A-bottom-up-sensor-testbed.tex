...
\label{Chapter5}
  ...
  \section{Actual Testbed}
    ...
    \subsection{Results}
      ...
      In the case of light, the sensor node in Barcelona receives direct sunlight during most of the day, but the node in Montgat and Badalona do not. Consequently, it is normal that the Barcelona node had a much higher light value. It is importante to consider that this node is located in an office, so is reasonable to think that the sudden drop from 100 lux to 10 or less may be becuase someone turn off the light of the office, and that the sunlight was gone a lot time ago.
...
\label{Chapter7}
  ...
  Finally the project could be difuse by a webpage or conference on sensors.

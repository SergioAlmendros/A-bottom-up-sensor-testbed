...
The arduino YUN is connected to Guifi, an open network built to everyone can join it providing his own connection.
...
\label{Chapter1}
  ...
  The development of this project involves two parts, collect sensory data and show it.
  ...
  As sensor nodes we will use an Arduino\footnote{\url{http://arduino.cc/}} YUN, which allows the user to obtain analog reads from a sensor very easily and, with a Power over Ethernet module, it can be attached to guifi\footnote{\url{http://guifi.net/}} nodes and send the sensory data to a sensor platform, like opencities\footnote{\url{http://opendata.nets.upf.edu/web/index.php/en/}}.
...
\label{Chapter2}
  ...
  \section{Opendata services}
    ...
    \subsection{Opencities}
       Opencities\footnote{\url{http://opendata.nets.upf.edu/web/index.php/en/}} is a platform to browse, visualize, and download open data from different participants. They offer free space in their server, which is perfect, a very simple API to upload and download data, and a web page to visualize the stored data.
       
    \subsection{Xively}
      Xively\footnote{\url{https://xively.com}} offers an Internet of Things platform as a service, basicaly it let you stored sensory data, download it, and visualize it in graphics.
...
\label{Chapter3}
  ...
  \section{Arduino vs Raspberry PI}
    ...
    \begin{figure}[htbp]
      \centering
          \includegraphics[scale=0.3]{./Figures/arduinoethernetpoe.jpg}
          \\
          \rule{15em}{0.5pt}
      \caption[Arduino Ethernet PoE]{Arduino Ethernet PoE.}
      \label{fig:arduinoethernetpoe}
    \end{figure}
    \begin{figure}[htbp]
      \centering
          \includegraphics[scale=0.3]{./Figures/poe-rpi.jpg}
          \\
          \rule{16em}{0.5pt}
      \caption[Raspberry Pi model B PoE]{Raspberry Pi model B PoE.}
      \label{fig:poerpi}
    \end{figure}
  ...
  \section{Sensors}
    ...
    \subsection{LM35: Temperature}
      ...
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=0.4]{./Figures/LM35.jpg}
              \\
              \rule{16em}{0.5pt}
      ...
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=0.8]{./Figures/Fritzing/TemperatureSensor_bb.png}
              \\
              \rule{18em}{0.5pt}
    ...
    \subsection{Light Dependent Resistor (LDR)}
      ...
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=0.2]{./Figures/LDR.jpg}
              \\
              \rule{20em}{0.5pt}
      ...
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=0.8]{./Figures/Fritzing/LightSensor_bb.png}
              \\
              \rule{18em}{0.5pt}
    ...
    \subsection{Emartee Mini Sound Sensor and Analog Sound Sensor Board Microphone MIC Controller: Noise}
      ...
      \begin{figure}[!htbp]
          \centering
              \includegraphics[scale=0.3]{./Figures/MiniSoundSensor.jpg}
              \\
              \rule{15em}{0.5pt}
      ...
      \begin{figure}[!htbp]
          \centering
              \includegraphics[scale=0.3]{./Figures/analognoisesensor.jpg}
              \\
              \rule{15em}{0.5pt}
    ...
    \subsection{Aosong DHT22 and DHT11: Humidity}
      ...
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=0.3]{./Figures/dht22.jpg}
              \\
              \rule{15em}{0.5pt}
          \caption[DHT22 sensor]{DHT22 sensor.}
          \label{fig:DHT22}
      \end{figure}
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=0.09]{./Figures/dht11.png}
              \\
              \rule{15em}{0.5pt}
          \caption[DHT11 sensor]{DHT11 sensor.}
          \label{fig:DHT11}
      \end{figure}
      \begin{figure}[!htbp]
          \centering
              \includegraphics[scale=0.8]{./Figures/Fritzing/HumiditySensor_bb.png}
              \\
              \rule{18em}{0.5pt}
          \caption[Humidity Sensor DHT22 Breadboard]{DHT22 Breadboard.}
          \label{fig:HumiditySensordht22_bb}
      \end{figure}
      \begin{figure}[!htbp]
          \centering
              \includegraphics[scale=0.8]{./Figures/Fritzing/HumiditySensorDht11_bb.png}
              \rule{18em}{0.5pt}
          \caption[DHT11 Breadboard]{Humidity Sensor DHT11 Breadboard.}
    ...
    \subsection{MQ135: Gas sensor}
      ...
      \begin{figure}[htbp]
          \centering
              \includegraphics[scale=0.2]{./Figures/mq135.jpg}
              \\
              \rule{15em}{0.5pt}
      ...
      \begin{figure}[!htbp]
          \centering
              \includegraphics[scale=0.8]{./Figures/Fritzing/GasSensor_bb.png}
              \\
              \rule{18em}{0.5pt}
  ...
  \section{Python}
    Because of the low memory for the arduino sketches, we have to use a python script that will run in the linux, called by the arduino sketch, to communicate with opencities. The version of python in the arduino is the 4.2.5. 
    
  \section{Guifi network}
  ...
  \section{Opencities}  
    ...
    Opencities had a getting started tutorial, so at the end, the user will have a dataset where the data will be stored.
...
\label{Chapter4}
  ...
  \section{Arduino}
    ...
    To get started with how the arduino YUN works, visit this website\footnote{\url{http://arduino.cc/en/Guide/ArduinoYun}}.
    ...
    \subsection{Collect sensory data}
      ...
      \begin{itemize}
        ...
        \item {\bf executePythonScript:} The script in python located in the SD card is in charge to create the GeoJSON with all the sensory data and upload it to opencities. This script is called by the arduino sketch.
      \end{itemize}
...
\label{Chapter5}
  ...
  \section{Actual Testbed}
    ...
    \subsection{Results}
      ...
      \TwoFig{./Figures/GraphicTemperature.png}{Graphic Temperature}{fg:GraphicTemperature}{./Figures/GraphicLight.png}{Graphic Light}{fg:GraphicLight}
      
      \TwoFig{./Figures/GraphicNoise.png}{Graphic Noise}{fg:GraphicNoise}{./Figures/GraphicHumidity.png}{Graphic Humidity}{fg:GraphicHumidity}
...
\label{Chapter6}
  ...
  In conclusion, the project satisfies the goals presented at the start, which are share sensory data on an open network, and let the users visualize it.

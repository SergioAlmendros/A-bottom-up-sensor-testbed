...
\begin{figure}[htbp]
    \centering
        \includegraphics[scale=0.5]{./Figures/sharp.jpg}
        \rule{35em}{0.5pt}
...
\label{Chapter4}
  ...
  \section{Android app}
    ...
    \subsection{Summary}
      ...
      To make easy to see the results of the testbed, I created an android application for the purpose of visualize this results. The application shows the data of the sensors in two ways, with markers which will show the actual value of the temperature or noise in that point, and, also, with heatmaps, the larger the value of the temperature or noise, the more intense the red will be. This can be seen in figure \ref{fig:App_Screenshot_3}.
      
      \begin{figure}[htbp]
        \centering
            \includegraphics[scale=0.5]{./Figures/App_Screenshot_3.jpg}
            \rule{35em}{0.5pt}
    ...
    \subsection{Interface}
      Explain how the user can use the aplication with screenshots.
      
    \subsection{Code}
      With flowcharts, explain how the app function.

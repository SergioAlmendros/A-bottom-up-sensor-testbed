...
\label{Chapter5}
  ...
  \subsection{Copy the scripts}
    We have to copy two files in the SDCard, the file "main.py" and "logData". We can do this in two ways, we can put the SDCard in to a computer an save the files in there, or we can copy the files into the arduino through the network with the following comand:

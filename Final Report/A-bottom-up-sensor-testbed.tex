...
\label{Chapter5}
  ...
  \subsection{Copy the scripts}
    ...
    We have to copy two files in the SDCard, the file "main.py" and "logData". We have two ways to do this, put the SDCard into a computer an save the files in there, or we can copy the files into the arduino through the network with the following comand:

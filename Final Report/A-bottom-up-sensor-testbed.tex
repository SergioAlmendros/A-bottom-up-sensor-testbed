  ...
  \section{Arduino Code}
    ...
    \subsection{Collect sensory data}
      ...
      \begin{tikzpicture}[node distance=2cm]
        ...
        \node (delay) [process, right of=ReadFile, xshift=2cm] {Dealy of 5 seconds};
    ...
    \subsection{Communication with opencities}
      ...
      With all this libraries we can communicate with opencities and store the sensory data recollected by the arduino. The \ref{fig:Python Script Flow Chart} figure explain how the arduino sketch works:\\

...
\begin{figure}[!htbp]
    \centering
        \includegraphics[scale=0.5]{./Images/LM35.jpg}
        \rule{35em}{0.5pt}
...
\begin{figure}[htbp]
    \centering
        \includegraphics[scale=0.3]{./Images/LDR.jpg}
        \rule{35em}{0.5pt}
...
\begin{figure}[!htbp]
    \centering
        \includegraphics[scale=0.5]{./Images/MiniSoundSensor.jpg}
        \rule{35em}{0.5pt}
...
\begin{figure}[htbp]
    \centering
        \includegraphics[scale=0.5]{./Images/dht22.jpg}
        \rule{35em}{0.5pt}
...
\begin{figure}[htbp]
    \centering
        \includegraphics[scale=0.5]{./Images/sharp.jpg}
        \rule{35em}{0.5pt}
...
\begin{figure}[htbp]
    \centering
        \includegraphics[scale=0.5]{./Images/ArduinoYunFront_2_450px.jpg}
        \rule{35em}{0.5pt}
...
\label{Chapter4}
  ...
  \section{Arduino Code}
    ...
    \subsection{Collect sensory data}
      ...
      The \ref{fig:Flow Chart} figure explain how the arduino sketch works:\\
    ...
    \subsection{Communication with opencities}
      ...
      Now it will be explained all the steps to install this libraries already mentioned:
      
      \begin{enumerate}
        \item First we need to configure the onboard wifi, in this website it is explained how
        \item When the YUN have an IP, now we can get into the linino by Secure Shell, if the YUN IP is 192.168.2.149: ssh root@192.168.2.149
      \end{enumerate}

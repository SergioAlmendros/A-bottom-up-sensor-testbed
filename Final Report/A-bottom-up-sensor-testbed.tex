...
\label{Chapter4}
  ...
  This chapter focused in the process that has been followed to complete the project, which has two main parts, the software to collect and send the data and the Android application to show it.
  ...
  \section{Arduino Development}
    ...
    \subsection{Communication with Opencities}
      ...
      With all this libraries the script can communicate with Opencities and store the sensor data collected by the arduino. The \ref{fig:Python Script Flow Chart} figure explain how the python script works.\\
...
\end{figure}
    ...
    \subsection{Code}
      ...
      The class diagram, in a reduce way, can be seen in the figure \ref{fig:ClassDiagram}

...
\label{Chapter2}
  ...
  \section{Companies}
    ...
    \subsection{Libelium}
      This company an Internet of things platform provider\footnote{\url{http://www.libelium.com/}}, which supply an open source sensor platform for the Internet of things.
      They have a variety of products, here are some:
      \begin{itemize}
  ...
  \section{Opendata services}
    ...
    Opencities\footnote{\url{http://opendata.nets.upf.edu/web/index.php/en/}}, a platform to browse, visualize, and download open data from different participants. We will only use this platform to store and download the data in the Android App.
  ...
  \section{Sensor boards}
    In this section we discuss some of the options we have to use as node.
    
    \subsection{Arduino YUN}
      - Explicar que tiene fisicamente.
      - Explicar lo de los dos procesadores.
      - Explicar la libreria bridge.
